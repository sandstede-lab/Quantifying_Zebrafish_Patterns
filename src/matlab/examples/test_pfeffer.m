...
fprintf('cd ../../python \n')
fprintf('python3 get_barcodes.py -i ../../data/sample_dist_mats/iriL_Pfeffer_Test_day56.txt -d 1 -o ../../data/sample_barcodes/iriL_Pfeffer_Test_day56 \n')
pause; 


PD_dir = '../../../data/sample_barcodes/iriL_Pfeffer_Test_day56_dim0';
